 ...
 */
define ('PDF_HEADER_LOGO', 'Logo_Indelec.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'ORDEN DE SERVICIO');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Indelec S.A.S - Industria Electronica S.A.S");
