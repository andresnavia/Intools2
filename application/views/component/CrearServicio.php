        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="HNav">Componentes / Servicios</h2>   
                        </div>
                    </div><!-- /. ROW  -->
                    <hr />
                    <div class="row">
                       <div class="col-md-12">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?= form_open(base_url('Servicio/Insertarcomponente'))?>
                                        <?php
                                        
                                            $servicio=array(  'id' => 'inputSuccess',
                                                        'class' => 'form-control',
                                                        'name' => 'Ser'
                                        ...
                                        <?php 
                                            ...
                                            $btn2=array('name' => 'button',
                                                        ...
                                                        'onClick' => "window.location.href = '".base_url()."Client/Consultar';return false;"
                                                        );
