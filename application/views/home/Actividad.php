                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                       ...
                       <?php
                        ...
                        <?php
                            $session_data = $this->session->userdata('logged_in');
                            if($session_data['rol_id']=='2' || $session_data['rol_id']=='5' ){
                        ?> 
                        <li>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    Actividad Trabajada Actualmente
                                </div> 
                                <div class="panel-body">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#1" data-toggle="tab"><h4>Actividades</h4></a>
                                        </li>
                                        <li><a href="<?= base_url()?>Home/Servicios" ><h4>Servicios</h4></a>
                                        </li>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table  class="table table-condensed table-bordered table-hover" id="dataTables-example1" data-sort-name="fecha" data-sort-order="desc">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a href="<?= base_url('Home/InicioActividad2/'.$a->id) ?>" class="btn btn-primary"><i class="fa fa-play" title="Continuar"></i></a>
                                                                        <a href="<?= base_url('Home/PausaActividad/'.$a->id) ?>" class="btn btn-danger"><i class="fa fa-pause" title="Pausar"></i></a>
                                                                    </td>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table  class="table table-condensed table-bordered table-hover" id="dataTables-example2" data-sort-name="fecha" data-sort-order="desc">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $horas=$this->db->query("select ha.fecha_inicio, ha.hora1, ha.hora2 from horas_actividad ha, 
                                                                    actividad a, tipo_actividad ta where ha.id_actividad=a.id and a.responsable=".$session_data['id']." and 
                                                                    ta.id=a.actividad and a.estado='1'");
                                                                    foreach ($horas->result() as $h):  
                                                                ?>
                                                                <tr>
